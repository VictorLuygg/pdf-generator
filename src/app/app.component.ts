...
// Importando as depedências do PDFMAKE

//import * as pdfMake from 'pdfmake/build/pdfmake';
const pdfMake = require('pdfmake/build/pdfmake.js'); //Importado assim para evitar ERROR TS2345
// Devido à forma como o typescript compila o código, que não muda o comportamento de um módulo. Como '@types/pdfmake' não exporta nada, é preciso definir como uma const.
// Para mais informações: https://stackoverflow.com/questions/67059704/angular-11-and-pdfmake-error-ts2345-argument-of-type-is-not-assignable-t
